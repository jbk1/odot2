...
#   let(:invalid_attributes) { { "title" => "M", "description" => "My" } }
...
#     context "with valid params" do
#       let(:new_attributes) { { "title" => "MyUpdatedString", "description" => "My Updated Description" } }

#       it "updates the requested todo_list" do
#         todo_list = TodoList.create! valid_attributes
#         put :update, {:id => todo_list.to_param, :todo_list => new_attributes}, valid_session
#         todo_list.reload
#         expect(todo_list.title).to eq("MyUpdatedString")
#       end
